...
export const dictionary = {
  ...
  'strip.langs':       { en: 'Guides speak EN · BHS',                    bcs: 'Vodiči pričaju EN · BHS' },
  ...
  'pkg.hiking.inc':    { en: 'Mountain trails above the Neretva canyon · eagle-view vantage points · local guide · light lunch on the trail',
                         bcs: 'Planinske staze iznad kanjona Neretve · vidikovci za orla · lokalni vodič · lagani ručak na stazi' },
  'pkg.hiking.who':    { en: 'For: hikers, day-trippers, anyone craving altitude',
                         bcs: 'Za: planinare, dnevne izletnike, ljubitelje visine' },

  'pkg.special.t':     { en: 'Special adventure packages',               bcs: 'Specijalne avanture' },
  'pkg.special.dur':   { en: 'Multi-day · custom-built',                 bcs: 'Više dana · pravljeno po mjeri' },
  'pkg.special.inc':   { en: 'Tailored combinations of rafting, canoeing, Prenj hikes, village stays and traditional meals — built around your group.',
                         bcs: 'Kombinacije raftinga, kanua, Prenja, smještaja i tradicionalnih obroka — pravljene oko vaše grupe.' },
  'pkg.special.who':   { en: 'For: serious groups, special occasions, companies',
                         bcs: 'Za: ozbiljne grupe, posebne prilike, firme' },
